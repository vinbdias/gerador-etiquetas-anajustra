...
var GeradorEtiquetasController = function () {
     ...
     * Método construtor
     */
    function GeradorEtiquetasController() {
        _classCallCheck(this, GeradorEtiquetasController);
    ...
    _createClass(GeradorEtiquetasController, [{
        key: '_iniciar_jQueryTagsManagerPlugin',
        value: function _iniciar_jQueryTagsManagerPlugin() {
        ...
        key: '_iniciar_jQueryTypeAheadPlugin',
        value: function _iniciar_jQueryTypeAheadPlugin() {
        ...
        key: '_iniciar_jQueryMaskPlugin',
        value: function _iniciar_jQueryMaskPlugin() {
        ...
        key: '_instanciarTypeAheadNome',
        value: function _instanciarTypeAheadNome() {
        ...
        key: '_instanciarTypeAheadCpf',
        value: function _instanciarTypeAheadCpf() {

            this._inputCpf.typeahead(null, {
                displayKey: 'cpf',
                source: this._pesquisaAssociados.ttAdapter()
            }).on('typeahead:selected', function (object, associado) {
    ...
    return GeradorEtiquetasController;
}();
//# sourceMappingURL=GeradorEtiquetasController.js.map